          ...
          <section className="flex flex-col w-full  items-center justify-center p-4 gap-x-32  justify-self-center py-24 ">
                   ...
                   <div className="mt-16 gap-5 justify-center items-center self-center w-full flex">
                       <div className=" grow flex flex-col items-center ">
                            <div className="border-2 rounded-2xl border-secondary w-[30em] h-[36em] bg-cover bg-[url(https://instagram.fadd2-1.fna.fbcdn.net/v/t51.82787-15/556866817_17868528669449043_4431612760684428392_n.jpg?stp=dst-jpg_e35_p640x640_sh0.08_tt6&_nc_cat=104&ig_cache_key=MzczMzQ4MTE1MTEyNjkyODE5Nw%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjEwMjR4MTI3Ni5zZHIuQzMifQ%3D%3D&_nc_ohc=qUvhwEFDEksQ7kNvwE7V6U-&_nc_oc=AdnYn-050hlm38TnpOVEGGAYuiLX9INOgbZ6hxVQ1ZFYvAWc0tkMCISI3btSLWVB5LI&_nc_ad=z-m&_nc_cid=1735&_nc_zt=23&_nc_ht=instagram.fadd2-1.fna&_nc_gid=rgkOjcxAT1V5tc576TdV2Q&oh=00_Afsp_xcyW6gyYl65CUOOwu07IMGxudaNCEowMKff46o8ng&oe=6999951E)]" />
                            </div>

                  <div className=" grow flex flex-col items-center">
                            <div className="border-2 rounded-2xl border-secondary w-[30em] h-[36em] bg-cover bg-center bg-[url(https://instagram.fadd2-1.fna.fbcdn.net/v/t51.82787-15/552851776_17867615853449043_2991054511939826681_n.jpg?stp=dst-jpg_e35_tt6&_nc_cat=104&ig_cache_key=MzcyNzU0MjQ1ODA4ODg2MTM5OA%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjkyOHgxMjM3LnNkci5DMyJ9&_nc_ohc=dO7an9HPtNwQ7kNvwH9rSbx&_nc_oc=AdleOb-bt_46XlvPbl9Z_wnsNmLRnqoRdU21j3Mcpx3hvjKHXZHKatymlj4i1p5iiXA&_nc_ad=z-m&_nc_cid=1735&_nc_zt=23&_nc_ht=instagram.fadd2-1.fna&_nc_gid=rgkOjcxAT1V5tc576TdV2Q&oh=00_AfuCNnrkGDU_LVjnKCSSivVCiggVRRin_NBkC5fR8ef47Q&oe=69998B64)]" />
                            </div>
                   <div className=" grow flex flex-col items-center ">
                            <div className="border-2 rounded-2xl border-secondary w-[30em] h-[36em] bg-cover bg-[url(https://instagram.fadd1-1.fna.fbcdn.net/v/t51.82787-15/542874986_17866109619449043_818838866944933470_n.jpg?stp=dst-jpg_e35_tt6&_nc_cat=101&ig_cache_key=MzcxODI2MTkwMTY2NDI2NTgwMQ%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjEwODB4MTM0Ni5zZHIuQzMifQ%3D%3D&_nc_ohc=StMEJgSMQbUQ7kNvwGgXvQ3&_nc_oc=AdlBkEe_2SLDXgh7nOo8pAE1NCjIiOlvNcb27CsfBRDBLddruVmhPR8FF7dMAwSDHPU&_nc_ad=z-m&_nc_cid=1735&_nc_zt=23&_nc_ht=instagram.fadd1-1.fna&_nc_gid=1wz6wXKrHqvEXFAIFeYiXw&oh=00_AfsIa4zuhg5r6kX4e4K0ZYqabfYGYYzCheLJOsxE91wOqw&oe=6999977D)]" />
                            </div>
                   </div>
